...
23/Oct/25
  This has been a really big jump from when last I updated this file due to the fact I signed an NDA, A lot has been accomplished and I'm now a bug bounty hunter. I won't be dropping as much info as I have been dropping before due to the fact I'm done with the learning process and into the application aspect of my journey. I will be signing more NDAs which is why I won't be dropping much info. But during the past few months I was able to go deep into ethical hacking and loved every aspect of the journey. I created a lot of labs and tried different test, expanded my knowledge and even got to the top 7% try hack me and top cybersecurites in Nigeria tryhackme. Now while I do my bug bounty hunting, I'm also learning about tkinter so I can build tools for cybersecurity engineers out there. My goal is to make an impact in the cybersecurity space as much as possible. Will be dropping as much update as I can.
